    ...
    data () {
      return {
        ...
        allRows: [
          ...
          {ids: '1-1-4-PCDD', class: 'code square width1-8 width1-9 blue default-color', titleClass: '', values: [{selected: false, title: '大单', value: '1', times: null, after: 18.8}, {selected: false, title: '大双', value: '2', times: 0, after: 18.8, afterIndex: 1}, {selected: false, title: '小单', value: '3', times: 0, after: 18.8, afterIndex: 1}, {selected: false, title: '小双', value: '4', times: 0, after: 18.8}]},
