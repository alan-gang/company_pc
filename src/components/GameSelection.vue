    ...
    data () {
      return {
        ...
        allRows: [
          ...
          {ids: '9-1-2', class: 'code square width1-8 blue default-color', innertitleCopy: '总和、龙虎', titleClass: '', values: [{selected: false, title: '总大', value: '1', times: null, after: 18.8}, {selected: false, title: '总小', value: '2', times: 0, after: 18.8}, {selected: false, title: '总单', value: '3', times: 0, after: 18.8}, {selected: false, title: '总双', value: '4', times: 0, after: 18.8}, {selected: false, title: '龙', value: '5', times: 0, after: 18.8, afterIndex: 1}, {selected: false, title: '虎', value: '6', times: 0, after: 18.8, afterIndex: 1}, {selected: false, title: '和', value: '7', times: 0, after: 18.8, afterIndex: 2}]},
          ...
          {ids: '9-7-1', class: 'code square width1-8 small-space small-space-s blue default-color', innertitle: '龙1vs虎2', titleClass: '', rowClass: 'third-half-row', values: [{selected: false, title: '龙1', vtitle: '龙', value: '3', times: 0, after: 18.8}, {selected: false, title: '和局', vtitle: '和', value: '4', times: 0, after: 18.8, afterIndex: 1}, {selected: false, title: '虎2', vtitle: '虎', value: '4', times: 0, after: 18.8}]},
          {ids: '9-7-1', class: 'code square width1-8 small-space small-space-s blue default-color', innertitle: '龙1vs虎3', vtitle: '龙', titleClass: '', rowClass: 'third-half-row', values: [{selected: false, title: '龙1', vtitle: '龙', value: '3', times: 0, after: 18.8}, {selected: false, title: '和局', vtitle: '和', value: '4', times: 0, after: 18.8, afterIndex: 1}, {selected: false, title: '虎3', vtitle: '虎', value: '4', times: 0, after: 18.8}]},
          {ids: '9-7-1', class: 'code square width1-8 small-space small-space-s blue default-color', innertitle: '龙1vs虎4', vtitle: '龙', titleClass: '', rowClass: 'third-half-row', values: [{selected: false, title: '龙1', vtitle: '龙', value: '3', times: 0, after: 18.8}, {selected: false, title: '和局', vtitle: '和', value: '4', times: 0, after: 18.8, afterIndex: 1}, {selected: false, title: '虎4', vtitle: '虎', value: '4', times: 0, after: 18.8}]},
          {ids: '9-7-1', class: 'code square width1-8 small-space small-space-s blue default-color', innertitle: '龙1vs虎5', vtitle: '龙', titleClass: '', rowClass: 'third-half-row', values: [{selected: false, title: '龙1', vtitle: '龙', value: '3', times: 0, after: 18.8}, {selected: false, title: '和局', vtitle: '和', value: '4', times: 0, after: 18.8, afterIndex: 1}, {selected: false, title: '虎5', vtitle: '虎', value: '4', times: 0, after: 18.8}]},
