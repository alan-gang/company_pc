    ...
    return {
       ...
       ***/
        ...
        ***/
        ...
        { ids: '2-1-1-HC6, 2-1-2-HC6, 2-1-3-HC6, 2-1-4-HC6, ', class: 'number-array full-width', title: '鼠', rowClass: 'half-row', values: [{ class: 'small-circle', selected: false, title: getNumberOfAnimal('鼠').join(', '), numbers: getColorsOfNumberArray(getNumberOfAnimal('鼠')), checkbox: true, after: 47.7, afterIndex: 1, value: 1 }] },
        ...
        { ids: '1-1-3-HC6, ', class: 'number-array full-width', title: '鼠', rowClass: 'half-row', values: [{ class: 'small-circle', selected: false, title: getNumberOfAnimal('鼠').join(', '), numbers: getColorsOfNumberArray(getNumberOfAnimal('鼠')), input: true, times: 0, after: 47.7, afterIndex: 1, value: 1 }] },
