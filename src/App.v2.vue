          ...
          groups: [
            {
              ...
              items: [
                ...
                {class: 'ds-icon-game-tx2fcos sign new', id: '1-1-12', menuid: '132', title: '奇趣5分彩', volume: true, gameid: 165},
                {class: 'ds-icon-game-tx2fcos sign new', id: '1-1-13', menuid: '133', title: '奇趣10分彩', volume: true, gameid: 166}
              ]
            },
            {
              url: 'SSC',
