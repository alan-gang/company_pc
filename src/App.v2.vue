          ...
          groups: [
            {
              ...
              items: [
                ...
                {class: 'ds-icon-game-tx2fcjs sign new', id: '1-1-10', menuid: '113', title: '腾讯2分彩奇', volume: true, gameid: 152},
                {class: 'ds-icon-game-tx2fcos sign new', id: '1-1-11', menuid: '114', title: '腾讯2分彩偶', volume: true, gameid: 153}
              ]
            },
            {
              url: 'SSC',
