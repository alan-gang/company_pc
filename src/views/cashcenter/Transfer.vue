...
export default {
  data () {
    return {
      ...
      f: '',
      froms: ['主帐户', '特殊帐户', 'BG帐户:2', 'IBC帐户:3', '棋牌帐户:7', 'PT帐户:5', 'AG帐户:4', '沙巴帐户:9', '乐游帐户:15', 'U赢帐户:17'],
      t: '',
      m: '',
      cpwd: '',
      btn: false
  ...
  computed: {
    ...
    tm () {
      switch (this.f) {
        case 0:
          return [this.ME.bgmoney, this.ME.tcgmoney, this.ME.kymoney, this.ME.ptmoney, this.ME.agmoney, this.ME.sbmoney, this.ME.lymoney, this.ME.uwinmoney][this.t]
        case 1:
          return this.ME.amoney
        case 2:
          return this.ME.amoney
    ...
    showSwitch () {
      return (this.f === 0 && this.t === 0) || (this.f === 2 && this.t === 0) || (this.f === 0 && this.t === 1) || (this.f === 3 && this.t === 0) || (this.f === 4 && this.t === 0) || (this.f === 0 && this.t === 2) || (this.f === 0 && this.t === 3) || (this.f === 0 && this.t === 4) || (this.f === 5 && this.t === 0) || (this.f === 6 && this.t === 0) || (this.f === 0 && this.t === 5) || (this.f === 7 && this.t === 0) || (this.f === 0 && this.t === 6) || (this.f === 8 && this.t === 0) || (this.f === 0 && this.t === 7) || (this.f === 9 && this.t === 0)
    },
    ccm () {
  ...
  methods: {
    ...
    getBalance () {
      this.$http.get(api.getBalance).then(({data}) => {
        if (data.success === 1) {
          store.actions.setUser({bgmoney: data.bgAmount || 0, tcgmoney: data.sportsAmount || 0, kymoney: data.kyAmount || 0, ptmoney: data.ptAmount || 0, agmoney: data.agAmount || 0, sbmoney: data.sbAmount || 0, lymoney: data.lyAmount, uwinmoney: data.uwinAmount})
        }
      }).catch(rep => {
    ...
    transferNowBG () {
      ...
      this.$message.success({target: this.$el, message: (['', '', 'BG', 'IBC', '棋牌', 'PT', 'AG', '沙巴', '乐游', 'U赢'][Math.max(this.f, this.t + 2)] + '余额转帐已提交！')})
