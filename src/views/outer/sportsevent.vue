// 三方 体育赛事
<template>
  <div class="outer-Common sportsevent">
    <div class="cw">
      <img class="titleimg" src="../../assets/outer/sportsevent/3.png" />
      <el-row class="list">
        <el-col :span="8">
          <div class="gamelist">
            <div class="gameimg">
