...
let getNumberOfAnimal = (s) => {
  ...
  if (index === 0) a = [1, 13, 25, 37, 49]; //鼠
  if (index === 1) a = [12, 24, 36, 48]; //牛
  if (index === 2) a = [11, 23, 35, 47]; //虎
  if (index === 3) a = [10, 22, 34, 46]; //兔
  if (index === 4) a = [9, 21, 33, 45]; //龙
  if (index === 5) a = [8, 20, 32, 44]; //蛇
  if (index === 6) a = [7, 19, 31, 43]; //马
  if (index === 7) a = [6, 18, 30, 42]; //羊
  if (index === 8) a = [5, 17, 29, 41]; //猴
  if (index === 9) a = [4, 16, 28, 40]; //鸡
  if (index === 10) a = [3, 15, 27, 39]; //狗
  if (index === 11) a = [2, 14, 26, 38]; //猪
